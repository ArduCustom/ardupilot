...
enum FlightOptions {
    ...
    CRUISE_HEADING_CONTROL_WITH_YAW_STICK = (1<<18),
    RTL_MANUAL_ALT_CONTROL = (1<<19),
    RTL_CLIMB_FIRST_ONLY_IN_FS = (1<<20),
    RTL_FAILSAFE_LAND_AFTER_2MIN = (1<<21),
    ALLOW_GLIDING_IN_AUTO_THR_MODES = (1<<22),
