...
#define MIN_AIRSPEED_MIN 5.0f // m/s, used for arming check and speed scaling
...
enum FlightOptions {
    ...
    CRUISE_HEADING_CONTROL_WITH_YAW_STICK = (1<<19),
    RTL_MANUAL_ALT_CONTROL = (1<<20),
    RTL_CLIMB_FIRST_ONLY_IN_FS = (1<<21),
    RTL_FAILSAFE_LAND_AFTER_2MIN = (1<<22),
