...
void Plane::set_gliding_requested(bool value)
{
    TECS_controller.set_gliding_requested_flag(value);
    gliding_requested = value;
}
...
void Plane::calc_nav_pitch()
{
    ...
    if (gliding_requested && !(ahrs.airspeed_sensor_enabled() || TECS_controller.is_using_synthetic_airspeed())) {
        nav_pitch_cd = -g.stab_pitch_down * 100;
        return;
    }
    ...
    if (!gliding_requested && control_mode->is_guided_mode() &&
