...
void ModeRTL::update()
{
    ...
    if (!plane.rtl.done_climb) {
        ...
        plane.roll_limit_cd = MIN(plane.roll_limit_cd, plane.g.rtl_level_roll_limit*100);
...
{
    // if (plane.g2.flight_options & FlightOptions::RTL_MANUAL_ALT_CONTROL && !plane.failsafe.rc_failsafe && !plane.rtl.triggered_by_rc_failsafe) {
