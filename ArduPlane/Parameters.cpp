...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("CRUISE_YAW_RATE", 52, ParametersG2, cruise_yaw_rate, 45),
