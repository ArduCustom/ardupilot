...
const AP_Param::Info Plane::var_info[] = {
    ...
    // @Description: Throttle under which to start pitching down to avoid stalling. The applied down pitch scales linearly from 0 to STAB_PITCH_DOWN with throttle between STAB_PTCHDN_THR and 0
    // @Range: 0 100
    // @Increment: 0.1
    // @Units: %
    // @User: Advanced
