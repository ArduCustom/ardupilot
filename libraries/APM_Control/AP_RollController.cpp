...
const AP_Param::GroupInfo AP_RollController::var_info[] = {
    ...
    // @Description: Roll axis angle controller P gain.  Converts the difference between desired roll rate and actual roll rate into a motor speed output
    // @Range: 0.08 0.35
    // @Increment: 0.005
    // @User: Standard
    ...
    // @Description: Roll axis angle controller I gain.  Corrects long-term difference in desired roll rate vs actual roll rate
    // @Range: 0.01 0.6
    // @Increment: 0.01
    // @User: Standard
    ...
    // @Description: Roll axis angle controller I gain maximum.  Constrains the maximum motor output that the I gain will output
    // @Range: 0 1
    // @Increment: 0.01
    // @User: Standard
    ...
    // @Description: Roll axis angle controller D gain.  Compensates for short-term change in desired roll rate vs actual roll rate
    // @Range: 0.001 0.03
    // @Increment: 0.001
    // @User: Standard

    // @Param: _AGL_FF
    // @DisplayName: Roll axis angle controller feed forward
    // @Description: Roll axis angle controller feed forward
    // @Range: 0 3.0
    // @Increment: 0.001
    // @User: Standard
