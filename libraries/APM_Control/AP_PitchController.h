...
#define ANGLE_PID_P_DEFAULT 4 // XXX necessary because otherwise the soaring checks fail for an unknown reason
#else
#define ANGLE_PID_P_DEFAULT 2 // equivalent to old P only default
#endif
...
private:
    ...
    AC_PID angle_pid{ANGLE_PID_P_DEFAULT, 0, 0, 0, 3, 3, 0, 12, 0.02, 0, 1};
