...
const AP_Param::GroupInfo AP_PitchController::var_info[] = {
	...
	// @Description: Maximum pitch up rate that the pitch controller demands (degrees/sec) in angle control modes (all but MANUAL and ACRO).
	// @Range: 0 100
	// @Units: deg/s
	// @Increment: 1
	// @User: Advanced
	...
	// @Description: This sets the maximum nose down pitch rate that the controller will demand (degrees/sec) in angle control modes (all but MANUAL and ACRO). Setting it to zero disables the limit.
	// @Range: 0 100
	// @Units: deg/s
	// @Increment: 1
	// @User: Advanced
