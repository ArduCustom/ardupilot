...
public:
    ...
    uint32_t get_boot_avg_flight_duration(void);
    uint32_t get_total_avg_flight_duration(void);
...
private:
    ...
    uint32_t _total_boot_average_flight_duration = 0;
