...
const AP_Param::GroupInfo AP_Stats::var_info[] = {
    ...
    // @ReadOnly: True
    // @User: Standard
    AP_GROUPINFO("_GND_DIST",    4, AP_Stats, params.flying_ground_traveled, 0),
    ...
    // @ReadOnly: True
    // @User: Standard
    AP_GROUPINFO("_AIR_DIST",    6, AP_Stats, params.flying_air_traveled, 0),
...
void AP_Stats::reset_params_if_requested(void)
{
    ...
    if (params_reset != _reset_tstamp_s || params_reset == 0) {
        ...
        params.boot_count.set_and_save_ifchanged(params_reset == 0 ? 1 : 0);
